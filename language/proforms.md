...
The basic
[proforms](https://en.wikipedia.org/wiki/Pro-form)
...
*pasme* "how". The other pronouns *jos*, *sjos*, etc. can be used analogously.

The inflection of the pronoun *pos* is as follows:

| | m. sg. | f. sg. | n. sg. | m. pl. | f. pl. | n. pl. |
|:--|
| nom. | pos | pa | pod | poi | pai | pa |
| voc. | po | pu | pod | poi | pai | pa |
| acc. | pom | pam | pod | pons | pans | pa |
| gen. | posio | pasias | posio | poisom | pasom | poisom |
...
The words *podi*, *poda*, *jodi*, *joda*, etc. are adverbs, so they do not
inflect.
